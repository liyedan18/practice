 ...
 *              3.该节点既有左子树，又有右子树，删除该节点后，
 *                  这里还有另一种方式，该节点的左子树移到后继节点的左子树，
 *                  然后将父节点指向该节点的右子树（也就是把当前节点等于右子树）
 *
 *      总结：
 *          二叉搜索树遍历框架 + 后继节点（前驱节点） + 分类处理（两个子树都或有一个子树==null,!=null）
 */
