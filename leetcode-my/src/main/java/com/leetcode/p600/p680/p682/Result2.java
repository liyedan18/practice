package com.leetcode.p600.p680.p682;
                ...
                s -> {
                    switch (s) {
                        ...
                        case "+":
                            ...
                            Integer preLastPoint = stack.peek();
                            Integer newLastPoint = lastPoint + preLastPoint;
                            stack.push(lastPoint);
                            stack.push(newLastPoint);
                            break;
                        default:
